  ...
  return (
    <>
      <TapTarget
        ...
        className="lit-accent lit-glow dock fixed right-4 [--dock:var(--nav-clearance)] z-40 flex h-14 w-14 items-center justify-center rounded-full text-primary-foreground transition-transform active:scale-95"
      >
